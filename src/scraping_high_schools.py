...
i = 1
high_url = "https://www.greatschools.org/virginia/schools/?gradeLevels%5B%5D=h&st%5B%5D=public_charter&st%5B%5D=public&view=table&page=" + str(i)
...
high_schools_df['percent_low_income'] = high_schools_df['percent_low_income'].str.replace('%', '')

high_schools_df['percent_low_income'] = high_schools_df['percent_low_income'].replace('?', np.nan)

high_schools_df.to_csv('../input/high_schools_data.csv', index=False)
print('exported data: ../input/high_schools_data.csv')